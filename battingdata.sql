...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2020 at 10:08 PM
...
--
-- Table structure for table `battingdata`
--
...
--
-- Indexes for table `battingdata`
--
ALTER TABLE `battingdata`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `battingdata`
--
ALTER TABLE `battingdata`
